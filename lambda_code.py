...
def validate_data(age, investment_amount, intent_request):
    ...
    # Validate that the user is between 0 and 65
    if age is not None:
        age = parse_int(
            age
        )
        if age <= 0 or age >= 65:
            return build_validation_result(
                False,
                "age",
                "To be eligible for this service, you should be between the age of 0 and 65 to use this service, "
    ...
    if investment_amount is not None:
        ...
        if investment_amount < 5000:
            return build_validation_result(
                False,
                "investmentAmount",
                "The amount to invest should be greater or equal to 5000, "
...
def investment_recommender(risk_level):
    risk_levels = {
...
def recommend_portfolio(intent_request):
    ...
    initial_recommendation = investment_recommender(risk_level)
    ...
    return close(
        ...
        "Fulfilled",
        {
            ...
            "content": """Thank you for the above information {}.
            Based on your chosen  level of investment risk:{} and investment amount of {} dollars, the recommended portfolio structure is {}. 
            """.format(
